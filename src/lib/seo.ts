...
export function getPersonJsonLd() {
    return {
        ...
        alternateName: ["Edwin Ayabie", "madvirus", "1madvirus"],
        url: siteUrl,
        image: absoluteUrl(portfolio.site.ogImage),
        jobTitle: "Technical Lead, Python Backend Engineer",
        description: portfolio.meta.description,
        email: "mailto:hi@beshel.dev",
        ...
        worksFor: [
            {
                "@type": "Organization",
                name: "AET Technologies",
            },
            {
                "@type": "Organization",
                name: "Synterra Digital",
                url: "https://synterradigital.ai",
            },
        ],
        sameAs: [
            "https://github.com/madvirus-ops",
            "https://linkedin.com/in/madvirus",
            "https://x.com/1madvirus",
        ],
    };
}
...
export function getItemListJsonLd() {
    return {
        ...
        "@type": "ItemList",
        "@id": `${siteUrl}/#projects`,
        name: "Selected projects by Edwin Beshel Ayabie",
...
export function getRootHead() {
    ...
    return {
        meta: [
            ...
            { title },
            { name: "description", content: description },
            { name: "author", content: "Edwin Beshel Ayabie" },
            { name: "creator", content: "Edwin Beshel Ayabie" },
            { name: "publisher", content: "Edwin Beshel Ayabie" },
            ...
            { property: "profile:first_name", content: "Edwin" },
            { property: "profile:last_name", content: "Beshel Ayabie" },
            { property: "profile:username", content: "madvirus" },
