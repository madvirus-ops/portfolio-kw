...
export function getPersonJsonLd() {
    return {
        ...
        "@id": `${siteUrl}/#person`,
        name: "Edwin Ayabie",
        alternateName: ["madvirus", "1madvirus"],
        url: siteUrl,
        ...
        email: "mailto:edwinayabie1@gmail.com",
...
export function getItemListJsonLd() {
    return {
        ...
        "@type": "ItemList",
        "@id": `${siteUrl}/#projects`,
        name: "Selected projects by Edwin Ayabie",
...
export function getRootHead() {
    ...
    return {
        meta: [
            ...
            { title },
            { name: "description", content: description },
            { name: "author", content: "Edwin Ayabie" },
            { name: "creator", content: "Edwin Ayabie" },
            { name: "publisher", content: "Edwin Ayabie" },
            ...
            { property: "profile:last_name", content: "Ayabie" },
